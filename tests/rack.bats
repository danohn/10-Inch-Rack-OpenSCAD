...
@test "IBM M70q Gen 5 (179x182.9x36.5)" {
    render_views "ibm_m70q_gen5" \
        -D 'component_width=179' -D 'component_depth=182.9' -D 'component_height=36.5'
    assert_views_exist "ibm_m70q_gen5"
}

@test "IBM M70q Gen 4 (179x183x34.5)" {
    render_views "ibm_m70q_gen4" \
        -D 'component_width=179' -D 'component_depth=183' -D 'component_height=34.5'
...
@test "HP Elite Mini 800 (177.5x175.2x34.3)" {
    render_views "hp_elite_mini_800" \
        -D 'component_width=177.5' -D 'component_depth=175.2' -D 'component_height=34.3'
    assert_views_exist "hp_elite_mini_800"
}

@test "M4 Mac Mini (127x127x50) 2U" {
    render_views "m4_mac_mini" \
        -D 'component_width=127' -D 'component_depth=127' -D 'component_height=50' \
        -D 'rack_height=2'
...
@test "BeeLink ME Mini (99x99x99) 3U" {
    render_views "beelink_me_mini" \
        -D 'component_width=99' -D 'component_depth=99' -D 'component_height=99' \
        -D 'rack_height=3'
...
@test "Synology DS223j (165x100x225.5) 5U" {
    render_views "synology_ds223j" \
        -D 'component_width=165' -D 'component_depth=100' -D 'component_height=225.5' \
        -D 'rack_height=5'
...
@test "Synology DS223 (165x108x232.7) 5U" {
    render_views "synology_ds223" \
        -D 'component_width=165' -D 'component_depth=108' -D 'component_height=232.7' \
        -D 'rack_height=5'
